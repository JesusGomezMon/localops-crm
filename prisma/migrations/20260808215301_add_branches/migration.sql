...
INSERT INTO "new_Appointment" ("createdAt", "customerId", "endsAt", "id", "notes", "serviceId", "source", "startsAt", "status", "tenantId") SELECT "createdAt", "customerId", "endsAt", "id", "notes", "serviceId", "source", "startsAt", "status", "tenantId" FROM "Appointment";
